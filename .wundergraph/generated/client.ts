...
export class Client {
	...
	private readonly applicationHash: string = "8e6e508f";
	...
	public query = {
		...
		JspUsers: async (options: RequestOptions<never, JspUsersResponse>) => {
			return await this.doFetch<JspUsersResponse>({
				method: "GET",
				path: "JspUsers",
				input: options.input,
				abortSignal: options.abortSignal,
	...
	public liveQuery = {
		...
		JspUsers: (
			options: RequestOptions<never, JspUsersResponse>,
			cb: (response: Response<JspUsersResponse>) => void
		) => {
			return this.startSubscription<JspUsersResponse>(
				{
					method: "GET",
					path: "JspUsers",
					input: options.input,
