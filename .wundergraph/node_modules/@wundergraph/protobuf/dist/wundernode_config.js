...
exports.ClaimConfig = exports.OperationAuthorizationConfig = exports.Operation = exports.RedisCacheConfig = exports.InMemoryCacheConfig = exports.ApiCacheConfig = exports.OpenIDConnectAuthProviderConfig = exports.GithubAuthProviderConfig = exports.AuthProvider = exports.CookieBasedAuthentication = exports.ApiAuthenticationConfig = exports.Api = exports.Logging = exports.Certificate = exports.Server = exports.WunderNodeConfig = exports.analyticsRequestTypeToJSON = exports.analyticsRequestTypeFromJSON = exports.AnalyticsRequestType = exports.argumentSourceToJSON = exports.argumentSourceFromJSON = exports.ArgumentSource = exports.hTTPMethodToJSON = exports.hTTPMethodFromJSON = exports.HTTPMethod = exports.signingMethodToJSON = exports.signingMethodFromJSON = exports.SigningMethod = exports.upstreamAuthenticationKindToJSON = exports.upstreamAuthenticationKindFromJSON = exports.UpstreamAuthenticationKind = exports.dataSourceKindToJSON = exports.dataSourceKindFromJSON = exports.DataSourceKind = exports.operationTypeToJSON = exports.operationTypeFromJSON = exports.OperationType = exports.claimToJSON = exports.claimFromJSON = exports.Claim = exports.apiCacheKindToJSON = exports.apiCacheKindFromJSON = exports.ApiCacheKind = exports.authProviderKindToJSON = exports.authProviderKindFromJSON = exports.AuthProviderKind = exports.logLevelToJSON = exports.logLevelFromJSON = exports.LogLevel = exports.protobufPackage = void 0;
exports.CorsConfiguration = exports.UserDefinedApi = exports.WunderGraphConfiguration = exports.WunderNodeAnalyticsData = exports.RequestAnalyticsRecord = exports.ArgumentConfiguration = exports.TypeField = exports.FieldConfiguration = exports.HTTPHeader = exports.URLQueryConfiguration = exports.RESTSubscriptionConfiguration = exports.JwtUpstreamAuthenticationWithAccessTokenExchange = exports.JwtUpstreamAuthenticationConfig = exports.UpstreamAuthentication = exports.FetchConfiguration_HeaderEntry = exports.FetchConfiguration = exports.GraphQLSubscriptionConfiguration = exports.DataSourceCustomStatic = exports.GraphQLFederationConfiguration = exports.DataSourceCustomDatabase = exports.DataSourceCustomGraphQL = exports.DataSourceCustomREST = exports.DataSourceConfiguration = exports.EngineConfiguration = exports.OperationMock = exports.OperationCacheConfig = exports.OperationAuthenticationConfig = exports.OperationLiveQueryConfig = void 0;
/* eslint-disable */
...
exports.ApiAuthenticationConfig = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = globalThis.Object.create(baseApiAuthenticationConfig);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.CookieBasedAuthentication = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = globalThis.Object.create(baseCookieBasedAuthentication);
        message.providers = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
exports.AuthProvider = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = globalThis.Object.create(baseAuthProvider);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseGithubAuthProviderConfig = { clientId: "", clientSecret: "" };
exports.GithubAuthProviderConfig = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = globalThis.Object.create(baseGithubAuthProviderConfig);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.OpenIDConnectAuthProviderConfig = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = globalThis.Object.create(baseOpenIDConnectAuthProviderConfig);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.OperationAuthorizationConfig = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = globalThis.Object.create(baseOperationAuthorizationConfig);
        message.claims = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
exports.ClaimConfig = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = globalThis.Object.create(baseClaimConfig);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.OperationLiveQueryConfig = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = globalThis.Object.create(baseOperationLiveQueryConfig);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.OperationAuthenticationConfig = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = globalThis.Object.create(baseOperationAuthenticationConfig);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.DataSourceCustomDatabase = {
    encode(message, writer = minimal_1.Writer.create()) {
        if (message.databaseQuerystring !== "") {
            writer.uint32(10).string(message.databaseQuerystring);
        }
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = globalThis.Object.create(baseDataSourceCustomDatabase);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.databaseQuerystring = reader.string();
                    break;
                case 2:
    ...
    fromJSON(object) {
        const message = globalThis.Object.create(baseDataSourceCustomDatabase);
        if (object.databaseQuerystring !== undefined &&
            object.databaseQuerystring !== null) {
            message.databaseQuerystring = String(object.databaseQuerystring);
        }
        else {
            message.databaseQuerystring = "";
        }
    ...
    fromPartial(object) {
        ...
        if (object.databaseQuerystring !== undefined &&
            object.databaseQuerystring !== null) {
            message.databaseQuerystring = object.databaseQuerystring;
        }
        else {
            message.databaseQuerystring = "";
        }
    ...
    toJSON(message) {
        const obj = {};
        message.databaseQuerystring !== undefined &&
            (obj.databaseQuerystring = message.databaseQuerystring);
...
exports.UpstreamAuthentication = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = globalThis.Object.create(baseUpstreamAuthentication);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.jwtWithAccessTokenExchangeConfig = exports.JwtUpstreamAuthenticationWithAccessTokenExchange.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if (object.jwtWithAccessTokenExchangeConfig !== undefined &&
            ...
            message.jwtWithAccessTokenExchangeConfig = exports.JwtUpstreamAuthenticationWithAccessTokenExchange.fromJSON(object.jwtWithAccessTokenExchangeConfig);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.jwtWithAccessTokenExchangeConfig !== undefined &&
            object.jwtWithAccessTokenExchangeConfig !== null) {
            message.jwtWithAccessTokenExchangeConfig = exports.JwtUpstreamAuthenticationWithAccessTokenExchange.fromPartial(object.jwtWithAccessTokenExchangeConfig);
        }
        else {
            message.jwtWithAccessTokenExchangeConfig = undefined;
        }
...
const baseJwtUpstreamAuthenticationConfig = {
    secret: "",
    signingMethod: 0,
};
exports.JwtUpstreamAuthenticationConfig = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = globalThis.Object.create(baseJwtUpstreamAuthenticationConfig);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.JwtUpstreamAuthenticationWithAccessTokenExchange = {
    encode(message, writer = minimal_1.Writer.create()) {
        ...
        if (message.accessTokenExchangeEndpoint !== "") {
            writer.uint32(26).string(message.accessTokenExchangeEndpoint);
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = globalThis.Object.create(baseJwtUpstreamAuthenticationWithAccessTokenExchange);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.accessTokenExchangeEndpoint = reader.string();
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if (object.accessTokenExchangeEndpoint !== undefined &&
            ...
            message.accessTokenExchangeEndpoint = String(object.accessTokenExchangeEndpoint);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.accessTokenExchangeEndpoint !== undefined &&
            object.accessTokenExchangeEndpoint !== null) {
            message.accessTokenExchangeEndpoint = object.accessTokenExchangeEndpoint;
        }
        else {
            message.accessTokenExchangeEndpoint = "";
        }
...
exports.RequestAnalyticsRecord = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = globalThis.Object.create(baseRequestAnalyticsRecord);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.WunderNodeAnalyticsData = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = globalThis.Object.create(baseWunderNodeAnalyticsData);
        message.requests = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
